...
import cn.tj.fnzi.wechat.fw.api.enums.MediaType;
import cn.tj.fnzi.wechat.fw.api.response.BaseResponse;
import cn.tj.fnzi.wechat.fw.api.response.DownloadMediaResponse;
import cn.tj.fnzi.wechat.fw.api.response.UploadMediaResponse;
import cn.tj.fnzi.wechat.fw.util.JSONUtil;
import cn.tj.fnzi.wechat.fw.util.NetWorkCenter;
import cn.tj.fnzi.wechat.fw.util.StreamUtil;
...
public class MediaAPI extends BaseAPI {
    ...
    private static final Logger LOG = LogManager.getLogger(MediaAPI.class);
